...
<form method="POST" action="process-feedback.php">
  <div class="container">
    ...
    <div class="form-group row">
      ...
      <div class="col-10">
        <input class="form-control" id="name" name="name" autofocus type="text" placeholder="Jason Candle">
      </div>
    </div>
    <div class="form-group row">
      <label for="email" class="col-2 col-form-label">Your Email</label>
      <div class="col-10">
        <input class="form-control" type="email" id="email" name="email" placeholder="jason@example.com">
      </div>
    </div>
    <div class="form-group row">
      <label for="feedback" class="col-2 col-form-label">Your feedback</label>
      <div class="col-10">
        <textarea class="form-control" id="feedback" name="feedback" rows="3" placeholder="I like the..."></textarea>
      </div>
    </div>
